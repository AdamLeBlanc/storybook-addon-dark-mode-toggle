...
export const Tool = () => {
  const userConfiguration = useParameter<typeof defaultConfiguration>(
    PARAM_KEY,
  ...
  useEffect(() => {
    ...
    const element = iframeDocument.querySelector(
      userConfiguration.querySelector
    );
    if (element) {
    ...
    >
      {isDark ? (
        <svg
          ...
          viewBox="0 0 24 24"
          width="24px"
          fill={userConfiguration.darkFill}
        >
          <g>
        ...
        <svg
          ...
          viewBox="0 0 24 24"
          width="24px"
          fill={userConfiguration.lightFill}
        >
          <rect fill="none" height="24" width="24" />
